...
export async function getAuthUser(request: Request): Promise<{ userId: string; fullName: string; employeeNo: string; role: 'SUPERADMIN' | 'ADMIN' | 'EMPLOYEE' | 'CANTEEN' | 'CASHIER' } | null> {
  try {
