      ...
      <header className="sticky top-0 z-30 h-16 bg-white border-b border-slate-100 flex items-center justify-between px-4 sm:px-6 shadow-xs">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="h-9 px-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold flex items-center gap-1.5 transition-colors shadow-xs"
            title="Export Excel"
          >
                          ...
                          {order.status !== 'CANCELLED' && (
                            <div className="flex items-center gap-1">
                              ...
                              <button
                                ...
                                className="h-7 px-2 rounded-lg text-[10px] font-bold text-rose-600 hover:bg-rose-50 border border-rose-200 transition-all active:scale-95 flex items-center gap-1"
